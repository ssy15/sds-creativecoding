...
"description": [ "acidic",
    ...
    "velvety",
    "vinegar"],
	"origin": ["It's friendsgiving!! what did you bring?\n #description.a# #food# :)",  "Happy Thanksgiving!! what did you bring? \n my mother's #food# ", " I BROUGHT EVERYBODY'S FAVORITE!!!! \n #description.a# #food# !!!!!!!!!", "OMG is that the famous #food# !!???!"]
}
